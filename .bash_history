...
python3 setup.py install
git pull
cd python-telegram-bot/rajue1068
git pull
s
ls
rm karken
...
mkdir
mkdir Karkenex
cp __init__.py Karkennex
cp api.py Karkenex
cp __init__.py Karkenex
cp version.py Karkenex
python telegram_kraken_bot.py
ren
rn
rename
rename Krakenex krakenex
mkdir karkenex
cp version.py karkenex
cp __init__.py karkenex
cp api.py karkenex
...
mkdir krakenex
cp api.py krakenex
cp __init__.py krakenex
cp version.py krakenex
python telegram_kraken_bot.py
...
pip install urllib # for python 2
pip install urllib # for python 3
pip install urllib3 # for python 2
python telegram_kraken_bot.py
...
sudo install urllib.request
pip install urllib3.request
pip install urllib3
cd ..
cd my_env/lib/python2.7/site-packages
ls
ls url
ls url*
ls
...
ls
python telebt.py
cp telebt.py telebt1.py
vi telebt1.py
python telebt1.py
vi telebt1.py
cd ..
cd telegram
cp sample1.py sample2.py
vi sample2.py
python sample2.py
vi sample2.py
python sample2.py
...
vi sample2.py
python sample2.py
sudo pip install --upgrade -e git+https://github.com/j2labs/dictshield.git#egg=dictshield
python sample2.py
vi sample2.py
python sample2.py
vi sample2.py
...
python sample2.py
vi sample2.py
git remote add origin https://github.com/raju1068/rajue1068.git
...
git remote add origin https://github.com/raju1068/rajue1068.git
git pull rajue1068
git pull rajue1068 master
git pull https://github.com/rajue1068/rajue1068 master
git pull https://github.com/raju1068/rajue1068 master
